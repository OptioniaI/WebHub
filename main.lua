--[[if game:GetService("CoreGui"):FindFirstChild("MainClass") then game:GetService("CoreGui"):FindFirstChild("MainClass"):Destroy() end
...
Frame.Name = "MainHolder"
Frame.Parent = Main

TextBox.Name = "ClassInput"
TextBox.Font = Enum.Font.Gotham
TextBox.Size = UDim2.new(.35, 0, .35, 0)
TextBox.Transparency = 1
TextBox.Text = "Enter Class here!"
...
TextBox.PlaceholderText = "Enter Class Here!"
TextBox.Parent = Frame

TextBox.FocusLost:Connect(function()
	game:GetService("Players").LocalPlayer.Stats.Class.Value = TextBox.Text
end)
...
function Library:Create(table)
    ...
    function tabHandler:Tab(name)
		...
		function ElementHandler:ToggleUI(text, default, callback)
            text = text or "Textbox"
            callback = callback or function() end

			Mouse.KeyDown:Connect(function(key)
				if key == default then
					darkUI.Enabled = not darkUI.Enabled
				end
			end)
